public class Conversion {
    public static void main(String [] args){
        ...
        System.out.println(new StringBuilder(dec2Bin(500)).reverse().toString());
        System.out.println(bin2Dec("111110100"));
        System.out.println(hex2Dec("0x07A120"));
        System.out.println("0x" + new StringBuilder(dec2Hex(500000)).reverse().toString());
    }
